/*Classe responsável por implementar as funções "Visit". Cadad função dessa tem como objetivo conferir a validade do documento solicitado. É feito o calculo com base na data de validade inserida na hora da instanciação, isso para os documetnos que possuem validade.
*/
package visitors;
